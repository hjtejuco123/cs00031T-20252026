; sam4m5.asm
; Demonstrates NASM macros (`%macro` / `%endmacro`) to reduce repetition when
; writing text with Linux syscalls. A checklist header and tasks are printed
; using reusable PRINT / PRINT_LINE helpers. Inline notes clarify how each macro
; expands to `sys_write` calls and how string lengths are computed.
