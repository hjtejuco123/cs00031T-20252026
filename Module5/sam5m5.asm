; sam5m5.asm
; Macro sample that mixes output and input. The program asks the user to
; rate their mood before studying, normalizes the response, and prints a
; matching encouragement. Comments describe what each macro expands to and why
; we manipulate the input byte with bitwise logic.
...
_start:
    ...
    READ_INPUT input_buf, 4       ; grab first character plus newline

    mov al, [input_buf]
    or  al, 0x20                  ; convert ASCII letter to lowercase ('H' -> 'h')
